...
def findSimilarUser(userId, userCat, userCatTraining):
    minDist=1000000
    bestUser=''
    userCategories_test_sample= userCatTraining.take(np.random.permutation(len(userCategories_test))[:500])
...
#userCategories_test_sample= userCategories_test.take(np.random.permutation(len(userCategories_test))[:100])
...
userCategories_test.to_csv('userCategories_test')
